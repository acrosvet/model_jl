...
include("stress.jl")
include("cull_seasonal.jl")
include("cull_split.jl")
include("cull_batch.jl")
include("cull_empty_dry.jl")
include("join_batch.jl")
include("join_seasonal.jl")
include("join_split.jl")
include("join_heifer_seasonal.jl")
include("join_heifer_batch.jl")
include("join_heifer_seasonal.jl")
include("join_heifer_split.jl")
include("dryoff_batch.jl")
include("dryoff_seasonal.jl")
include("dryoff_split.jl")
include("update_msd.jl")
include("update_psc.jl")
include("update_bactopop.jl")
include("current_stock.jl")