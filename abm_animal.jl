# ABM - Animal  --------------------
    ...
    function initialiseModel(
        ...
        stage = :C,
        calday = 183,
        num_calves = (calday > 182 && calday < 272) ? Int(floor(N*0.2*rand(0.9:0.05:1.1))) : 0,
        num_weaned = (calday ≥ 272 && calday ≤ 365 ) ? Int(floor(N*0.2*rand(0.9:0.05:1.1))) : 0,
        num_heifers = Int(floor(N*0.3*rand(0.9:0.05:1.1))),
